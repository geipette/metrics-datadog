...
public class HttpTransport implements Transport {
  ...
  public static class Builder {
    ...
    public Builder withProxy(HttpHost proxy) {
      this.proxy = proxy;
      return this;
    }
  ...
  public static class HttpRequest implements Transport.Request {
    ...
    public void send() throws Exception {
      ...
      Response response = buildRequest(postBody).execute();
    ...
    private org.apache.http.client.fluent.Request buildRequest(String postBody) {
      ...
      addProxySettings(request);

      return request;
    }

    private void addProxySettings(org.apache.http.client.fluent.Request request) {
